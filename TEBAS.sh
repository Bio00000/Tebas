...
echo
echo
toilet -f future "    Defacer Tools By BIO00000" | lolcat
echo
echo $red"##########################$green" DEFACER "$red###########################"
echo $yellow
figlet -f future "BIO00000"
echo
echo $red"##########################$green" DEFACER "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"BIO00000"$cyan" ~/"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"BIO00000"$cyan" ~/"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script nya cok!!! "
echo $green "╭─"$blue"BIO00000"$cyan" ~/Nama SC Harus (index.html) ganti dulu sana"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"BIO00000"$cyan" ~/"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $green"Author   : BIO00000			"
echo $purple"Github  : https://github.com/Bio00000"
echo
